...
import 'package:tunesock/CustomWidgets/box_switch_tile.dart';
...
import 'package:tunesock/main.dart';
          ...
          children: [
            ListTile(
              ...
              trailing: DropdownButton(
                    ...
                    setState(
                      () {
                        ...
                        MyApp.of(context).setLocale(
                          Locale.fromSubtags(
                            languageCode: LanguageCodes.languageCodes[newValue] ?? 'en',
                          ),
                        );
                ...
                items: LanguageCodes.languageCodes.keys.map<DropdownMenuItem<String>>((language) {
                  ...
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      final controller = TextEditingController(
                        text: settingsBox.get('proxyIp', defaultValue: '103.47.67.134').toString(),
                      );
                      final controller2 = TextEditingController(
                        text: settingsBox.get('proxyPort', defaultValue: 8080).toString(),
                      );
                      return AlertDialog(
                        ...
                        actions: [
                          ...
                          TextButton(
                            style: TextButton.styleFrom(
                              foregroundColor:
                                  Theme.of(context).colorScheme.secondary == Colors.white ? Colors.black : null,
