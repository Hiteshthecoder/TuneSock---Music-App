...
import 'package:tunesock/Screens/Settings/player_gradient.dart';
                                      ...
                                      setStt(
                                        () {
                                          if (isChecked!) {
                                            ...
                                            checked.removeWhere(
                                              (int element) => element == value['index'],
                                            );
                                          }
                                        },
                                      );
                          ...
                          actions: [
                            ...
                            TextButton(
                              ...
                              onPressed: () {
                                ...
                                for (int i = 0; i < sectionsAvailableToShow.length; i++) {
                                  if (checked.contains(sectionsAvailableToShow[i])) {
                                    newSectionsToShow.add(sectionsAvailableToShow[i]);
                                  } else {
                                    if (remaining > 0) {
                                      newSectionsToShow.add(sectionsAvailableToShow[i]);
                                      remaining--;
