...
class BouncyImageSliverScrollView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double expandedHeight = MediaQuery.of(context).size.height * (fromYt ? 0.2 : 0.4);
        ...
        AnimatedBuilder(
          ...
          builder: (context, child) {
            if (scrollController.offset.roundToDouble() > expandedHeight - 80) {
              ...
              scrollController.offset.roundToDouble() / (expandedHeight - 80) > 0
                  ? _opacity.value = scrollController.offset.roundToDouble() / (expandedHeight - 80)
                  : _opacity.value = 0;
            }
            return SliverAppBar(
              elevation: 0,
