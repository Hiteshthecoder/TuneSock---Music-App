...
import 'package:tunesock/APIs/api.dart';
import 'package:tunesock/CustomWidgets/download_button.dart';
import 'package:tunesock/CustomWidgets/empty_screen.dart';
import 'package:tunesock/CustomWidgets/gradient_containers.dart';
import 'package:tunesock/CustomWidgets/image_card.dart';
import 'package:tunesock/CustomWidgets/like_button.dart';
import 'package:tunesock/CustomWidgets/media_tile.dart';
import 'package:tunesock/CustomWidgets/search_bar.dart' as searchbar;
import 'package:tunesock/CustomWidgets/snackbar.dart';
import 'package:tunesock/CustomWidgets/song_tile_trailing_menu.dart';
import 'package:tunesock/Helpers/extensions.dart';
import 'package:tunesock/Screens/Common/song_list.dart';
import 'package:tunesock/Screens/Common/song_list_view.dart';
import 'package:tunesock/Screens/Search/albums.dart';
import 'package:tunesock/Screens/Search/artists.dart';
import 'package:tunesock/Screens/YouTube/youtube_artist.dart';
import 'package:tunesock/Screens/YouTube/youtube_playlist.dart';
import 'package:tunesock/Services/player_service.dart';
import 'package:tunesock/Services/youtube_services.dart';
import 'package:tunesock/Services/yt_music.dart';
...
class _SearchPageState extends State<SearchPage> {
  ...
  String searchType = Hive.box('settings').get('searchType', defaultValue: 'saavn').toString();
  List searchHistory = Hive.box('settings').get('search', defaultValue: []) as List;
  // bool showHistory =
  //     Hive.box('settings').get('showHistory', defaultValue: true) as bool;
  bool liveSearch = Hive.box('settings').get('liveSearch', defaultValue: true) as bool;
    ...
    switch (searchType) {
      case 'ytm':
        ...
        YtMusicService().search(query == '' ? widget.query : query).then((value) {
          setState(() {
            final songSection = value.firstWhere((element) => element['title'] == 'Songs');
      ...
      case 'yt':
        ...
        YouTubeServices().fetchSearchResults(query == '' ? widget.query : query).then((value) {
          setState(() {
            searchedList = value;
            fetched = true;
          });
      ...
      default:
        ...
        searchedList = await SaavnAPI().fetchSearchResults(query == '' ? widget.query : query);
                              ...
                              (int index) {
                                return Padding(
                                  padding: EdgeInsets.symmetric(
                                    horizontal: 5.0,
                                    vertical: (Platform.isWindows || Platform.isLinux || Platform.isMacOS) ? 5.0 : 0.0,
                                  ),
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Text(
                                        AppLocalizations.of(context)!.trendingSearch,
                                        style: TextStyle(
                                            ...
                                            children: [
                                                                        ...
                                                                        pageBuilder: (
                                                                          ...
                                                                          onTap: (index, listItems) async {
                                                                            ...
                                                                            if (response != null &&
                                                                              ...
                                                                              response['image'] = response2['image'] ??
                                                                                  response['image'];
                                                                            }
                                              ...
                                              ListView.builder(
                                                ...
                                                itemBuilder: (context, index) {
                                                  final int count = items[index]['count'] as int? ?? 0;
                                                  final itemType =
                                                      items[index]['type']?.toString().toLowerCase() ?? 'video';
                                                  String countText = '';
                                                  if (count >= 1) {
                                                    count > 1
                                                        ? countText = '$count ${AppLocalizations.of(context)!.songs}'
                                                        : countText = '$count ${AppLocalizations.of(context)!.song}';
                                                  }
                                                  return MediaTile(
                                                    ...
                                                    isThreeLine: countText != '',
                                                    leadingWidget: imageCard(
                                                      borderRadius:
                                                          title == 'Artists' || itemType == 'artist' ? 50.0 : 7.0,
                                                      placeholderImage: AssetImage(
                                                        title == 'Artists' || itemType == 'artist'
                                                            ? 'assets/artist.png'
                                                            : title == 'Songs'
                                                                ? 'assets/cover.jpg'
                                                                : 'assets/album.png',
                                                    ...
                                                    trailingWidget: searchType != 'saavn'
                                                        ...
                                                        : title != 'Albums'
                                                            ? title == 'Songs'
                                                                ...
                                                                : null
                                                            : AlbumDownloadButton(
                                                                albumName: items[index]['title'].toString(),
                                                                albumId: items[index]['id'].toString(),
                                                              ),
                                                    onTap: searchType != 'saavn'
                                                        ? () async {
                                                            if (itemType == 'artist') {
      ...
      return Padding(
        ...
        child: ChoiceChip(
          ...
          labelStyle: TextStyle(
            ...
            fontWeight: searchType == element['key'] ? FontWeight.w600 : FontWeight.normal,
          ),
          ...
          onSelected: (bool selected) {
            if (selected) {
              ...
              if (element['key'] == 'ytm' || element['key'] == 'yt') {
                Hive.box('settings').put('searchYtMusic', element['key'] == 'ytm');
              }
              setState(() {});
            }
          },
