...
import 'package:tunesock/Helpers/search_add_playlist.dart';
          ...
          itemBuilder: (ctxt, idx) {
            ...
            return playTotal == 0
                ...
                : ListTile(
                    ...
                    leading: imageCard(
                      imageUrl: (spotifyPlaylists[idx - 1]['images'] as List).isEmpty
                          ? ''
                          : spotifyPlaylists[idx - 1]['images'][0]['url'].toString(),
                    ),
                    onTap: () async {
                      Navigator.pop(context);
                      final String playName = spotifyPlaylists[idx - 1]['name'].toString().replaceAll('/', ' ');
                      final String playlistId = spotifyPlaylists[idx - 1]['id'].toString();
