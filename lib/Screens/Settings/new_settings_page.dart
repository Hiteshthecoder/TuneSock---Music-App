...
import 'package:tunesock/Screens/Settings/about.dart';
import 'package:tunesock/Screens/Settings/app_ui.dart';
import 'package:tunesock/Screens/Settings/backup_and_restore.dart';
import 'package:tunesock/Screens/Settings/download.dart';
import 'package:tunesock/Screens/Settings/music_playback.dart';
import 'package:tunesock/Screens/Settings/others.dart';
import 'package:tunesock/Screens/Settings/theme.dart';
...
class _NewSettingsPageState extends State<NewSettingsPage> with AutomaticKeepAliveClientMixin<NewSettingsPage> {
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index) {
            return ListTile(
              ...
              isThreeLine: !isRotated && (settingsList[index]['isThreeLine'] as bool? ?? false),
              onTap: () {
                searchQuery.value = '';
                controller.text = '';
                Navigator.push(
  ...
  List<Map> _getSearchResults(
    ...
    final List<Map> options = query != ''
        ? searchOptions
            .where(
              (element) => element['title'].toString().toLowerCase().contains(query),
            )
            .toList()
        : List.empty();
    return options;
