                  ...
                  child: TextField(
                    ...
                    onChanged: (val) {
                      ...
                      if (widget.liveSearch && val.trim() != '') {
                        ...
                        Future.delayed(
                          ...
                          () async {
                            if (tempQuery == val && tempQuery.trim() != '' && tempQuery != query) {
                              query = tempQuery;
                              if (widget.onQueryChanged == null) {
                                widget.onSubmitted(tempQuery);
                              } else {
                                suggestionsList.value = await widget.onQueryChanged!(tempQuery);
                              }
                            }
                          },
                        );
                    ...
                    onSubmitted: (submittedQuery) {
                      ...
                      if (submittedQuery.trim() != '') {
                        ...
                        List searchQueries = Hive.box('settings').get('search', defaultValue: []) as List;
                                  ...
                                  itemBuilder: (context, index) {
                                    return ListTile(
                                      ...
                                      onTap: () {
                                        ...
                                        hide.value = true;
                                        List searchQueries = Hive.box('settings').get(
                                          'search',
                                          defaultValue: [],
                                        ) as List;
