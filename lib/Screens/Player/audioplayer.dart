...
import 'package:tunesock/CustomWidgets/add_playlist.dart';
import 'package:tunesock/CustomWidgets/animated_text.dart';
...
import 'package:tunesock/CustomWidgets/equalizer.dart';
import 'package:tunesock/CustomWidgets/gradient_containers.dart';
import 'package:tunesock/CustomWidgets/like_button.dart';
import 'package:tunesock/CustomWidgets/popup.dart';
import 'package:tunesock/CustomWidgets/seek_bar.dart';
import 'package:tunesock/CustomWidgets/snackbar.dart';
import 'package:tunesock/CustomWidgets/textinput_dialog.dart';
import 'package:tunesock/Helpers/config.dart';
import 'package:tunesock/Helpers/dominant_color.dart';
import 'package:tunesock/Helpers/lyrics.dart';
import 'package:tunesock/Helpers/mediaitem_converter.dart';
...
class _PlayScreenState extends State<PlayScreen> {
  final String gradientType = Hive.box('settings').get('gradientType', defaultValue: 'halfDark').toString();
  final bool getLyricsOnline = Hive.box('settings').get('getLyricsOnline', defaultValue: true) as bool;

  final MyTheme currentTheme = GetIt.I<MyTheme>();
  final ValueNotifier<List<Color?>?> gradientColor = ValueNotifier<List<Color?>?>(GetIt.I<MyTheme>().playGradientColor);
      ...
      Lyrics.getOffLyrics(
        ...
        if (value == '' && widget.getLyricsOnline) {
          Lyrics.getLyrics(
            ...
            lyricsReaderModel = LyricsModelBuilder.create().bindLyricToMain(lyrics['lyrics'].toString()).getModel();
          });
        } else {
                ...
                ValueListenableBuilder(
                  ...
                  builder: (
                    ...
                    return Align(
                      ...
                      child: Text(
                        'Powered by $value',
                        style: Theme.of(context).textTheme.bodySmall!.copyWith(fontSize: 10.0, color: Colors.white70),
                      ),
                    );
                  },
                ),
