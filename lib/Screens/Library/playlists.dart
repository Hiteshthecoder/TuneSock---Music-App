...
import 'package:tunesock/Screens/Library/import.dart';
                                ...
                                onPressed: () async {
                                  try {
                                    ...
                                    if (playlistsToMerge.length > 1) {
                                      final finalMap = {};
                                      for (final String playlistName in playlistsToMerge.sublist(1)) {
                                        try {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final String showName =
                          playlistDetails.containsKey(name) ? playlistDetails[name]['name']?.toString() ?? name : name;
                      return ListTile(
