...
import 'package:tunesock/Helpers/picker.dart';
...
Future<Map> editTags(Map song, BuildContext context) async {
  await showDialog(
    ...
    builder: (BuildContext context) {
      ...
      final titlecontroller = TextEditingController(text: song['title'].toString());
      final albumcontroller = TextEditingController(text: song['album'].toString());
      final artistcontroller = TextEditingController(text: song['artist'].toString());
      final albumArtistController = TextEditingController(text: song['albumArtist'].toString());
      final genrecontroller = TextEditingController(text: song['genre'].toString());
      final yearcontroller = TextEditingController(text: song['year'].toString());
      final pathcontroller = TextEditingController(text: song['path'].toString());
                    ...
                    return ListTile(
                      leading: imageCard(
                        ...
                        localErrorFunction: (_, __) {
                          if (widget.songs[index]['image'] != null && widget.songs[index]['image_url'] != null) {
                            downImage(
