...
import 'package:tunesock/Screens/Home/saavn.dart' as home_screen;
import 'package:tunesock/Screens/Top Charts/top.dart' as top_screen;
...
class _MusicPlaybackPageState extends State<MusicPlaybackPage> {
  String streamingMobileQuality = Hive.box('settings').get('streamingQuality', defaultValue: '96 kbps') as String;
  String streamingWifiQuality = Hive.box('settings').get('streamingWifiQuality', defaultValue: '320 kbps') as String;
