...
class BouncyPlaylistHeaderScrollView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double expandedHeight =
        rotated ? MediaQuery.of(context).size.width * 0.35 : MediaQuery.of(context).size.width * 0.6;
    final double screenWidth =
        rotated ? MediaQuery.of(context).size.width * 0.3 : MediaQuery.of(context).size.width * 0.5;
