...
class _EqualizerState extends State<Equalizer> {
  bool enabled = Hive.box('settings').get('setEqualizer', defaultValue: false) as bool;
...
class _EqualizerControlsState extends State<EqualizerControls> {
  Future<Map> getEq() async {
    final Map parameters = await widget.audioHandler.customAction('getEqualizerParams') as Map;
    return parameters;
  }
...
class _VerticalSliderState extends State<VerticalSlider> {
  ...
  void setGain(int bandIndex, double gain) {
    ...
    widget.audioHandler.customAction('setBandGain', {'band': bandIndex, 'gain': gain});
  }
