...
import 'package:tunesock/Helpers/audio_query.dart';
// import 'package:tunesock/Screens/LocalMusic/localplaylists.dart';
...
class _DownloadedSongsDesktopState extends State<DownloadedSongsDesktop> with TickerProviderStateMixin {
  List<Map> _songs = [];
        ...
        for (final file in files) {
          if (file.path.endsWith('.mp3') || file.path.endsWith('.m4a')) {
            _songs.add({
              ...
              'title': (file.path.split('\\').last.split('.')..removeLast()).join(),
              'artist': 'Unknown',
              'album': 'Unknown',
              'image': '',
              'year': '',
...
class _AlbumsTabDesktopState extends State<AlbumsTabDesktop> with AutomaticKeepAliveClientMixin {
  @override
  bool get wantKeepAlive => true;
